...
#[no_mangle]
pub unsafe extern "C" fn connect_p(v: *mut PetriNet, position: *mut FFIPosition, transition: *mut FFITransition) {
    let v = &mut *v;
    let position = &mut *position;
    let transition = &mut *transition;
...
#[no_mangle]
pub unsafe extern "C" fn connect_t(v: *mut PetriNet, transition: *mut FFITransition, position: *mut FFIPosition) {
    let v = &mut *v;
    let position = &mut *position;
    let transition = &mut *transition;
...
#[no_mangle]
pub unsafe extern "C" fn remove_connection_p(v: *mut PetriNet, position: *mut FFIPosition, transition: *mut FFITransition) {
    let v = &mut *v;
    let position = &mut *position;
    let transition = &mut *transition;

    v.connections.drain_filter(|c| c.first().eq(&position.0) && c.second().eq(&transition.0));
}

#[no_mangle]
pub unsafe extern "C" fn remove_connection_t(v: *mut PetriNet, transition: *mut FFITransition, position: *mut FFIPosition) {
    let v = &mut *v;
    let position = &mut *position;
    let transition = &mut *transition;

    v.connections.drain_filter(|c| c.first().eq(&transition.0) && c.second().eq(&position.0));
}